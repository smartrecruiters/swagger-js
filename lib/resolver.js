...
Resolver.prototype.resolveTo = function (root, property, resolutionTable, location) {
  ...
  if ((typeof ref !== 'undefined') && (ref !== null)) {
    if(ref.indexOf('#') >= 0) {
      ...
      if(logged[root].indexOf(ref) < 0) {
        logged[root].push(ref);
        console.warn("Probably invalid swagger definition: " + root + " because referencing not defined '" + ref + "'. Anyway, processing further.");
      }
      location = '';
      lroot = root;
    }
